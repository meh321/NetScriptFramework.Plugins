...
namespace CraftingSkill
{
    public sealed class CraftingSkillPlugin : Plugin
    {
        ...
        private void init()
        {
            ...
            {
                fn_Disenchant = NetScriptFramework.Main.GameInfo.GetAddressOf(11213);
            ...
            {
                fn_Alchemy1 = NetScriptFramework.Main.GameInfo.GetAddressOf(50424);
                fn_Alchemy2 = NetScriptFramework.Main.GameInfo.GetAddressOf(50463);
        ...
        private static void _Hook_Disenchanting(CPURegisters ctx)
        {
            ...
            float enchantmentValue = Memory.InvokeCdeclF(fn_Disenchant, enchantment, 0);

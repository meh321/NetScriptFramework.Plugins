...
{
    class VampireLord : CameraState
    {
        internal override int Priority
        {
            get
            {
                return (int)Priorities.VampireLord;
            }
        }
        ...
        internal override bool Check(CameraUpdate update)
        {
            ...
            string want = Settings.Instance.VampireLordRaceName;
    ...
    class VampireLordTransform : CameraState
    {
        internal override int Priority
        {
            get
            {
                return (int)Priorities.VampireLordTransform;
            }
        }
        ...
        private void init()
        {
            ...
            uint id = Settings.Instance.VampireLordTransformationEffectId;
            string file = Settings.Instance.VampireLordTransformationEffectFile;
